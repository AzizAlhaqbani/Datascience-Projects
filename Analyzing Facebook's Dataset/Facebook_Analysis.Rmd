...
Is there a correlation between having many virtual friends and receiving *likes* from them?
...
We explored a several set of Facebook's dateset variables, along with multiple visualization that shed the lights on hidden insights. Human behavior and the psychology behind using social media can be revealed further from such datasets since most of us typically spend long hours a day surfing them, they undeniably have become quite a part of our lives. It is the role of data analysis come to play, extract meaningful knowledge from seemingly raw data.
